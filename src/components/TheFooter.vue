<template>
  <footer class="bg-white">
    <div class="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
      ...
      <p class="mt-8 text-center text-base text-gray-400">&copy; 2022 Quanterall. All rights reserved.</p>
    </div>
  </footer>
</template>
...
const navigation = {
  ...
  social: [
    {
      name: 'Facebook',
      href: 'https://www.facebook.com/quanterall/',
    ...
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/quanterall/',
      icon: defineComponent({
        render: () =>
          h('svg', { fill: 'currentColor', viewBox: '0 0 24 24' }, [
            h('path', {
    ...
    {
      name: 'Twitter',
      href: 'https://github.com/quanterall',
      icon: defineComponent({
        render: () =>
          h('svg', { fill: 'currentColor', viewBox: '0 0 24 24' }, [
            h('path', {
